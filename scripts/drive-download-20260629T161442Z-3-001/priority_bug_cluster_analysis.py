...
Output:
    - priority_bug_cluster_interactive2.html
    - priority_bug_cluster_static2F.png
...
OUTPUT_HTML = os.path.join(BASE_DIR, "4priority_bug_cluster_interactive.html")
OUTPUT_PNG = os.path.join(BASE_DIR, "4priority_bug_cluster_static.png")
...
def run():
        ...
        if out_x:
            ...
            for i in range(len(out_x)):
                ax.annotate(
                    ...
                    bbox=dict(boxstyle='round,pad=0.2', facecolor='white', alpha=0.7, edgecolor=COLORS[pri])
                )
    ...
    ax.set_title(
        ...
        f"Core bugs ● | Outliers ✕ with Bug ID | "
